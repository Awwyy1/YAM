        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="pt-40 pb-20 px-6 md:px-12 max-w-7xl mx-auto">
            ...
            <div className="mb-40">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                    {[
                        { src: "/images/gallery/coffee-1.jpg", span: "row-span-2" },
                        { src: "/images/gallery/coffee-2.jpg", span: "" },
                        { src: "/images/gallery/coffee-3.jpg", span: "" },
                        { src: "/images/gallery/coffee-4.jpg", span: "" },
                        { src: "/images/gallery/coffee-5.jpg", span: "col-span-2 md:col-span-1" },
                        { src: "/images/gallery/coffee-6.jpg", span: "hidden md:block" },
                    ].map((img, i) => (
          ...
          {location.pathname === '/' && (
            <motion.div key="home" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
              <section className="pt-44 pb-20 px-6 md:px-12 flex flex-col items-center text-center">
                ...
                <div className="mt-28 w-full max-w-5xl aspect-video rounded-[40px] overflow-hidden shadow-2xl"><img src="/images/hero/hero-1.jpg" className="w-full h-full object-cover" alt="Coffee" /></div>
              </section>
